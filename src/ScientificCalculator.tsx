...
const ScientificCalculator: React.FC<ScientificCalculatorProps> = ({ title }) => {
    ...
    return (
        <Paper elevation={3} sx={{ p: 2, borderRadius: 2, maxWidth: 400, margin: 'auto', bgcolor: 'background.paper' }}>
